...
Begin Task 4 from committed ai-nix revision `c0c194c78f54cd59c7176b0ba5f8515bbcde17db`, starting with the named `ai-home-manager-smoke` RED boundary in the approved plan. Do not execute Task 13 without separate durable authority.
