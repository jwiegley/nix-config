...
class CodexEnvTests(unittest.TestCase):
    ...
    def test_missing_or_empty_credential_refuses_before_codex(self) -> None:
        for pass_body in ("exit 1", "printf '\\n'"):
            with (
                self.subTest(pass_body=pass_body),
