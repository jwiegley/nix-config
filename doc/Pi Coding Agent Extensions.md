...
| Native overrides | Managed native-provider model IDs and context windows come from `config/ai/models.nix` |
...
| oMLX | 0.6.3rc1 | [oMLX Provider][pi-provider-omlx] and managed Sol route | [GitHub](https://github.com/jundot/omlx) |
