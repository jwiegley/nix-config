    ...
    rec {
      ...
      org-mem = compileEmacsFiles {
        ...
        src = fetchFromGitHub {
          owner = "meedstrom";
          repo = "org-mem";
          rev = "2e8807c72209831403fffe1ed62f0a12f227b24c";
          sha256 = "sha256-Q97A899J1+CGO4LiIT5DoDekcv4QsXlbVGr4suRweDU=";
      ...
      org-node = compileEmacsFiles {
        ...
        src = fetchFromGitHub {
          owner = "meedstrom";
          repo = "org-node";
          rev = "942e864604c85fa6b23d45ac0ce45b8ed74133c5";
          sha256 = "sha256-yKUwoID5LPUCV/+GqwSJ9Cc7vGcZdxuqZINkrIURNd8=";
