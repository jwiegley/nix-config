...
in {
      ...
      in {
        ...
        standard-distutils = pfinal.buildPythonPackage rec {
          ...
          meta = {
            ...
            license = super.lib.licenses.psfl;
          };
        };
  ...
  mcp-server-sequential-thinking =
    super.mcp-server-sequential-thinking.overrideAttrs
    (old: { dontNpmPrune = true; });

  rustdocs-mcp-server = with super;
  ...
  browser-control-mcp = with super;
    buildNpmPackage (finalAttrs: {
