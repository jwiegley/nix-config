...
iTerm2 = self.installApplication rec {
  ...
  src = super.fetchurl {
    url = "https://iterm2.com/downloads/stable/iTerm2-3_1_6.zip";
    sha256 = "11q0dg26nm9kx8v2lfn4wxlqzj4zjddf9fafpd4xp7pr90mh3ksa";
    # date = 2018-04-23T12:54:35-0700;
  };
...
KeyboardMaestro = self.installApplication rec {
  ...
  src = super.fetchurl {
    url = http://files.stairways.com/keyboardmaestro-823.zip;
    sha256 = "10s0vjmabymmbycn56zzjgm56q2rs45lck528fqpw5hqa0na8iaw";
    # date = 2018-08-02T15:46:51-0400;
  };
