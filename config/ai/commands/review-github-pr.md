...
- If this worktree is anywhere under the "positron" or "pos" directories, then use PAL to confer with `@NIX_MODEL_PAL_REASONING@` and `@NIX_MODEL_PAL_PARTNER@` to reach consensus on your deep analysis and review.
