    ...
    in
    {
      ...
      apps = forAllSystems (
        ...
        in
        {
          ...
          coverage = self.apps.${system}.test;
          coverage-check = self.apps.${system}.test;
          profile = self.apps.${system}.build-check;
          profile-check = self.apps.${system}.build-check;
          fuzz = self.apps.${system}.test;
          memory-check = self.apps.${system}.test;
      ...
      checks = forAllSystems (
        ...
        in
        {
          ...
          '';
          coverage = self.checks.${system}.tests;
          profile = self.checks.${system}.build;
          fuzz = self.checks.${system}.tests;
          memory = self.checks.${system}.tests;
